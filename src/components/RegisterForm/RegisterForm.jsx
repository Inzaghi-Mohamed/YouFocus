    ...
    <form className="max-w-md mx-auto p-6 bg-white mt-20 rounded-lg shadow-md" onSubmit={registerUser}>
      ...
      <div className="flex items-center justify-center flex-col ">
        <input
          ...
          value="Sign Up"
        />
        <p className='font-thin mt-2'>By clicking Sign Up, you agree to our <a href="https://www.facebook.com/legal/terms/update" target='_blank' className='text-blue-700 hover:underline'>terms</a>, <a href="#" className='text-blue-700 hover:underline'>Privacy Policy</a> and <a href="#" className='text-blue-700 hover:underline'>Cookies Policy.</a></p>
      </div>
    </form>
  );
}
